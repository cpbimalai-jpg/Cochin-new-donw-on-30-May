const properties = [
  {
    ...
    roadAccess: {
      ...
      condition: "Excellent, fully tarred municipal access",
      monsoonSafety: "High - no known approach-road water accumulation",
      limitations: "Peak-hour queue near Seaport-Airport junction"
    },
    checklist: {
      ...
      waterSource: "KWA water connection + open well",
      powerBackup: "DG backup for common areas",
      lift: "2 passenger lifts",
      security: "24/7 CCTV, guard, intercom",
      maintenanceMonthly: 2800
    },
    builderReputation: {
      background: "Confident Group is a large Kerala residential developer with a long operating history.",
      completedProjectsLast5Years: "Multiple completed residential projects across Kerala.",
      constructionQualityRating: "4.2 / 5.0 - solid mid-market construction quality.",
      positiveFeedback: "Clear documentation support and competitive locations.",
      negativeFeedback: "Some buyers may prefer upgraded interior fittings.",
      overallAssessment: "Reliable developer profile for budget-to-premium segments."
    },
    neighborhoodDetails: {
      residentialQuality: "Tech-workforce family crowd with modern suburban amenities.",
      trafficConditions: "Some congestion during Infopark shift hours.",
      safety: "Generally safe residential corridor.",
      cleanliness: "Good municipal coverage in active residential pockets.",
      appreciationPotential: "High due to Kakkanad growth and metro expansion expectations."
    },
    floodRisk: {
      classification: "Low Risk",
      historicalFlooding: "Elevated Kakkanad ridge location reduces flood exposure.",
      waterloggingReports: "No major stagnation reported for the immediate approach in this sample.",
      drainageConditions: "Natural slope supports runoff into municipal drains.",
      residentFeedback: "Residents generally report monsoon comfort in elevated pockets."
    },
    scores: {
      locationConnectivity: 16,
      floodRisk: 15,
      legalClarity: 15,
      builderReputation: 9,
    ...
    pros: [
      "Low flood exposure due to elevated location",
      "Strong appreciation potential around Kakkanad",
      "Clear ready-to-move documentation",
      "Competitive base price for a 3 BHK"
    ],
    cons: [
      "Current metro access is not walkable",
      "Peak-hour traffic can be slow",
      "Interior fittings are standard rather than premium"
    ],
...
const matchesFilters = (property: any, filters: any) => {
...
export default function handler(req: any, res: any) {
  ...
  const data = properties.filter((property) => matchesFilters(property, filters));
